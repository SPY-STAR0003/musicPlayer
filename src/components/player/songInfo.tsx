...
// assets
import defaultMusicCover from "./../../assets/images/default-music-icon.png";
    ...
    return (
        <>
            ...
            <div className={`relative group flex items-center justify-center rounded-full w-72 h-72 mb-4`}>
                <div className={`${isPlaying && "animate-smallPing"} absolute border-2 w-full h-full rounded-full`}></div>
                <img className={`group-hover:scale-125 z-10 rounded-full border-2 transition`} src={currentMusic.cover ?? defaultMusicCover} alt={currentMusic.name} />
            </div>
